...
<div class="container d-flex align-items-center min-vh-100 text-danger">
      <div class="container border rounded ">
        ...
        <p class="fs-1"><img src='ressources/images/trash-can.png' style='width:50px;height:50px'></p>
          <h1>Are you sure?</h1>
        </div>
    
        <div class="container border-bottom text-center pt-4 pb-4">
            <form id="deleteTemplateForm" action="Template/deleteTemplate/<?=$tricount->id?>/<?=$template->id?>" method="POST">
                    <p>Do you really want to delete Tricount "<span style="font-weight:bold;"><?=$template->title?></span>" and all of its dependencies ?<p>
